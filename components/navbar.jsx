...
const Header = ({ homeRef, aboutRef, contactRef, projectRef }) => {
    ...
    return (
        <>
            {/* ----- Mobile Nav ----- */}
            <nav className="w-[100%] py-3 px-3 md:px-12 md:hidden sticky flex justify-between items-center bg-[#101110]">
                            ...
                            <div className="px-[1em] fixed top-[6em]">                    
                                <ul className="flex flex-col items-start justify-center gap-y-8">
                                    <li 
                                        ...
                                        className="text-xl text-[#ffffffb3] hover:text-white duration-100 transition-all cursor-pointer"
                                    >
                                        Home
                                    </li>
                                    <li 
            ...
            {/* ----- Website Nav ----- */}
            <nav className="w-[100%] py-3 px-3 lg:px-12 hidden sticky bg-[#101110]">
